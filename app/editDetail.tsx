        ...
        <div className=" w-[96]">
          <div>
            {/* <div className="bg-white rounded-lg shadow-md p-3">
              <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="User Avatar" className="rounded-full w-28 h-26 mx-auto mb-4" />
